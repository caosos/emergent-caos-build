...
Tests core readiness for deployment on https://swarm-command-4.preview.emergentagent.com/api
...
# Configuration
BACKEND_URL = "https://swarm-command-4.preview.emergentagent.com/api"
