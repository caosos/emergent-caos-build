...
Tests core readiness for deployment on https://caos-command-center.preview.emergentagent.com/api
...
# Configuration
BACKEND_URL = "https://caos-command-center.preview.emergentagent.com/api"
