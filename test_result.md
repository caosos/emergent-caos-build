...
test_plan:
  current_focus:
    - "CAOS page scroll behavior - CRITICAL REGRESSION: Boxed-layout / missing-scrollbar issue has returned"
  stuck_tasks:
    - "CAOS page scroll behavior - Deployed/live-style scroll with page scroll instead of internal scroller"
  test_all: false
...
test_plan:
  current_focus:
    - "Scroll lock-up fix verification - All tests passed, READY FOR PRODUCTION"
  stuck_tasks: []
  test_all: false
  test_priority: "high_first"
