...
test_plan:
  current_focus:
    - "Scroll lock-up fix verification - CRITICAL: Header not accessible when scrolled (stuck_count: 1)"
  stuck_tasks:
    - "Scroll lock-up fix verification - Header accessibility still broken after multiple attempts"
  test_all: false
  test_priority: "high_first"
